...
<html>
	...
	<body>
		...
		<div id="edit-cannedValue" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${cannedValue}">
			<ul class="errors" role="alert">
				<g:eachError bean="${cannedValue}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:cannedValue, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${cannedValue?.version}" />
				<fieldset class="form">
