...
<html>
	...
	<body>
		...
		<div id="edit-suggestedName" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${suggestedName}">
			<ul class="errors" role="alert">
				<g:eachError bean="${suggestedName}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:suggestedName, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${suggestedName?.version}" />
				<fieldset class="form">
