...
//        properties.put(ownerProperty)
        ...
        jsonFeature.put(FeatureStringEnum.DATE_LAST_MODIFIED.value, neo4jObject.lastUpdated.time)
        jsonFeature.put(FeatureStringEnum.DATE_CREATION.value, neo4jObject.dateCreated.time)
        return jsonFeature
    }
